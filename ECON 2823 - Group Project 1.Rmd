...
rankplot <- ggplot(aa, aes(x=reorder(team, -mean), y=mean))+geom_bar(stat='identity', fill="#4eb14e") +  xlab("Team Names") + ylab("Expected Rank") + ggtitle("Visualization of Average Team Rankings") + coord_flip()
rankplot
```
